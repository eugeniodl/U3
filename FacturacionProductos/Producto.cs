...
namespace FacturacionProductos
{
    ...
    public abstract class Producto
    {
        ...
        // Método abstracto que obliga a las clases derivadas a implementar su 
        // propio cálculo de precio final
    ...
    public sealed class ProductoPerecedero : Producto
    {
        ...
        public override decimal CalcularPrecioFinal()
        {
            // Si el producto está a punto de caducar, aplicamos un descuento del 20%
