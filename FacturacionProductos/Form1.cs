namespace FacturacionProductos
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            cboTipoProducto.SelectedIndex = 0; // Seleccione Producto General por defecto
        }

        private void cboTipoProducto_SelectedIndexChanged(object sender, EventArgs e)
        {
            // Si el tipo de producto es Peredero, mostrar el DateTimePicker 
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Dependiendo del tipo de producto, creamos una instacnia
